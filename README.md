...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/polished-lab-37a6#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/polished-lab-37a6
```

A live public deployment of this template is available at [https://polished-lab-37a6.templates.workers.dev](https://polished-lab-37a6.templates.workers.dev)
